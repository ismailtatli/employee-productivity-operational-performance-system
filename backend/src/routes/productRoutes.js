 ...
 */
router.get("/", authenticateToken, authorizeRoles("Admin", "Manager", "Production", "Quality"), productController.getAllProducts);
 ...
 *         description: Product not found
 */
router.get("/:id", authenticateToken, authorizeRoles("Admin", "Manager", "Production", "Quality"), productController.getProductById);
